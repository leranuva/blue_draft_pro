    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                TextInput::make('estimated_value')->label('Estimated value ($)')->numeric()->minValue(0)->step(0.01),
                TextInput::make('internal_cost_estimate')->label('Internal cost ($)')->numeric()->minValue(0)->step(0.01),
                TextInput::make('expected_margin')->label('Expected margin ($)')->numeric()->step(0.01),
                TextInput::make('closed_value')->label('Closed value ($)')->numeric()->minValue(0)->step(0.01),
