...
<body>
    ...
    <div class="content">
        ...
        <a href="<?php echo e(config('app.url')); ?>#quote" class="button">Get Your Free Estimate</a>
        <p>— The Blue Draft Team</p>
    </div>
    <div class="footer">Blue Draft Construction — Quality you can trust</div>
</body>
</html>
<?php /**PATH C:\projects\blue_draft_pro\resources\views/emails/sequence/6-objection-crusher.blade.php ENDPATH**/ ?>