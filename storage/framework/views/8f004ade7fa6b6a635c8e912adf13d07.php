...
<?php $__env->startSection('title', 'NYC Renovation Cost Calculator | Blue Draft'); ?>
<?php $__env->startSection('meta_description', 'Estimate your renovation costs in New York City. Kitchen, bathroom, basement, and commercial remodeling cost ranges. Borough-adjusted pricing.'); ?>

<?php $__env->startPush('meta'); ?>
    <link rel="canonical" href="<?php echo e(route('cost-calculator')); ?>">
    ...
    <meta property="og:url" content="<?php echo e(route('cost-calculator')); ?>">
...
<script type="text/javascript">
    window.__costCalculatorConfig = <?php echo json_encode($config, 15, 512) ?>;
</script>
<section class="py-16 bg-white dark:bg-gray-900">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8" x-data="costCalculator()">
            ...
            <div x-show="step === 2 && sqft > 0" x-cloak
                ...
                <a :href="lockEstimateUrl()"
                   ...
                   class="mt-4 inline-flex items-center bg-[#003366] dark:bg-[#336699] text-white px-6 py-3 rounded-lg hover:bg-[#004080] dark:hover:bg-[#4a90e2] transition-all font-medium text-sm">
                    <?php echo e($hero['cta_lock_estimate'] ?? 'Lock This Estimate — Send to Our Project Manager'); ?>
        ...
        <div class="mt-12 text-center">
            ...
            <a href="<?php echo e(route('home')); ?>#quote" class="inline-flex items-center bg-[#003366] dark:bg-[#336699] text-white px-8 py-4 rounded-lg hover:bg-[#004080] dark:hover:bg-[#4a90e2] transition-all font-medium text-lg">
        ...
        <p class="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
            <a href="<?php echo e(route('lead-magnet.show')); ?>" class="text-[#336699] hover:underline">Download our free renovation guide</a> for more tips.
        </p>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\blue_draft_pro\resources\views/pages/cost-calculator.blade.php ENDPATH**/ ?>