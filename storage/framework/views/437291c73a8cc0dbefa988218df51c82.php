<?php $__env->startSection('title', 'Blue Draft — Project Proposal & Usage Guide'); ?>
<?php $__env->startSection('meta_description', 'Professional project proposal for Blue Draft: conversion-optimized construction website with lead automation, SEO, and full commercial pipeline.'); ?>
...
npm run dev</code></pre>
        ...
        <footer class="mt-20 text-center py-12 border-t border-gray-200 dark:border-gray-700">
            ...
            <a href="<?php echo e(route('home')); ?>" class="inline-block mt-4 px-6 py-2 bg-[#003366] text-white rounded-lg hover:bg-[#004080] transition-colors font-medium">
                Back to Site
            </a>
        </footer>
    </main>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\blue_draft_pro\resources\views/pages/project-proposal.blade.php ENDPATH**/ ?>