...
<script type="application/ld+json">
{
    ...
    "telephone": "<?php echo e($contact['phone'] ?? $contact['phone_link'] ?? '+13476366128'); ?>",
    "address": {
        "@type": "PostalAddress",
        "streetAddress": "<?php echo e($contact['address'] ?? '358 Amboy St, Brooklyn'); ?>",
    ...
    ,"aggregateRating": {
        ...
        "ratingValue": "<?php echo e($avgRating); ?>",
        "bestRating": "5",
        "worstRating": "1",
        "ratingCount": "<?php echo e(count($reviews)); ?>",
        "reviewCount": "<?php echo e(count($reviews)); ?>"
    }
    <?php endif; ?>
}
</script>
<?php /**PATH C:\projects\blue_draft_pro\resources\views/components/schema-local-business.blade.php ENDPATH**/ ?>