...
<body>
    ...
    <div class="content">
        ...
        <p>We wanted to follow up — we've had a lot of interest in <?php echo e(ucfirst($quote->service_type)); ?> projects this season.</p>
        <div class="urgency">
...
<?php /**PATH C:\projects\blue_draft_pro\resources\views/emails/sequence/4-urgency.blade.php ENDPATH**/ ?>