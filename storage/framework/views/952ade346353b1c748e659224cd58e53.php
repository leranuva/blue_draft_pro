...
<?php $__env->startSection('title', 'Project Evaluation — Blue Draft'); ?>
...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ activeTab: 'summary' }">
    ...
    <section id="modules" class="presentation-section py-16 bg-[#CCCC99]/10 dark:bg-gray-800/30">
        ...
        <div class="space-y-4" x-data="{ expanded: null }">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white dark:bg-gray-800/50 rounded-xl overflow-hidden border border-[#CCCC99]/30 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-shadow">
                <button @click="expanded = expanded === <?php echo e($i); ?> ? null : <?php echo e($i); ?>"
                    ...
                    <span class="font-semibold text-gray-900 dark:text-white group-hover:text-[#003366] dark:group-hover:text-white"><?php echo e($mod['title']); ?></span>
                    <svg class="w-5 h-5 text-[#336699] dark:text-[#4a90e2] transition-transform flex-shrink-0" :class="expanded === <?php echo e($i); ?> ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div x-show="expanded === <?php echo e($i); ?>"
                    ...
                    <ul class="space-y-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mod['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="text-center py-16 rounded-2xl overflow-hidden relative bg-gradient-to-r from-[#003366] via-[#003366] to-[#336699] text-white shadow-xl">
        ...
        <div class="relative z-10">
            ...
            <a href="<?php echo e(route('home')); ?>#contact" class="inline-flex items-center gap-2 bg-white text-[#003366] px-8 py-4 rounded-lg font-semibold hover:bg-[#CCCC99] transition-all shadow-lg hover:shadow-xl">
                Contact Us
...
<?php echo $__env->make('layouts.presentation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\blue_draft_pro\resources\views/presentation/evaluacion.blade.php ENDPATH**/ ?>