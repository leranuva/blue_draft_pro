...
@section('title', 'Blue Draft - Expert Construction Solutions')

@section('content')
    <!-- Hero Section - Minimalist & Elegant with Reveal Animation -->
    <section id="home" class="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden {{ $hero['background_image'] ? '' : 'bg-gradient-to-b from-[#CCCC99] via-white to-[#f5f5f0]' }}">
        @if($hero['background_image'])
            <!-- Background Image Container with Overlays -->
            <div class="absolute inset-0 z-0">
                <!-- Background Image -->
                <img src="{{ Storage::disk('public')->url($hero['background_image']) }}" 
                     alt="Hero Background" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-left reveal">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="tel:{{ str_replace(['.', ' ', '-'], '', $hero['phone']) }}" class="text-white hover:text-[#CCCC99] px-8 py-4 rounded-lg border-2 border-white/50 hover:border-white transition-all font-medium text-lg inline-flex items-center justify-center backdrop-blur-sm bg-white/10">
                ...
                <div class="relative hidden lg:block reveal" style="z-index: 10; position: relative;">
                    <div class="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl">
                        @if($hero['placeholder_image'])
                            <!-- Mostrar imagen de fondo si está configurada -->
                            <img src="{{ Storage::disk('public')->url($hero['placeholder_image']) }}" 
                                 alt="{{ $hero['image_text'] }}" 
                        ...
                        <div class="absolute inset-0 flex items-center justify-center z-[2]" style="z-index: 2;">
                            <div class="text-center text-white">
                                <svg class="w-24 h-24 mx-auto mb-4 text-white drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: white; filter: drop-shadow(0 4px 6px rgba(0, 0, 0, 0.5));">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="{{ $hero['image_svg_path'] }}"></path>
                                </svg>
                                <p class="text-lg font-medium text-white drop-shadow-lg">{{ $hero['image_text'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="about" class="py-24 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20 reveal">
                <span class="text-sm font-medium text-[#336699] dark:text-[#4a90e2] uppercase tracking-wider mb-4 block">{{ $about['badge'] }}</span>
                <h2 class="text-4xl md:text-5xl font-serif font-bold text-[#003366] dark:text-white mb-6">{{ $about['title'] }}</h2>
                <div class="w-20 h-0.5 bg-[#CCCC99] dark:bg-[#4a90e2] mx-auto"></div>
            </div>
            
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="reveal">
                    <h3 class="text-3xl font-serif font-bold text-[#003366] dark:text-white mb-6">{{ $about['subtitle'] }}</h3>
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="text-center">
                            <div class="text-3xl font-bold text-[#003366] dark:text-white mb-1">{{ $about['stat_years'] }}</div>
                        ...
                        <div class="text-center">
                            <div class="text-3xl font-bold text-[#003366] dark:text-white mb-1">{{ $about['stat_projects'] }}</div>
                            <div class="text-sm text-gray-500 dark:text-gray-400">Projects Completed</div>
                        </div>
                        <div class="w-px h-12 bg-[#CCCC99] dark:bg-gray-600"></div>
                        <div class="text-center">
                            <div class="text-3xl font-bold text-[#003366] dark:text-white mb-1">{{ $about['stat_satisfaction'] }}</div>
                        ...
                        <div class="absolute inset-0 flex items-center justify-center" style="z-index: 2;">
                            <div class="text-center text-white">
                                <svg class="w-32 h-32 mx-auto mb-4 text-white drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: white; filter: drop-shadow(0 4px 6px rgba(0, 0, 0, 0.5));">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="{{ $about['image_svg_path'] }}"></path>
                                </svg>
                                <p class="text-lg font-medium text-white drop-shadow-lg">{{ $about['image_text'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="aspect-[4/3] relative overflow-hidden">
                                <div class="relative w-full h-full">
                                    ...
                                    <div class="absolute top-4 left-4">
                                        <span class="bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-xs font-medium text-[#003366] shadow-sm capitalize">{{ $project->category }}</span>
                                    </div>
                        ...
                        <div x-show="activeFilter === 'all' || activeFilter === '{{ $project->category }}'" 
                            ...
                            <div class="aspect-[4/3] bg-gradient-to-br from-[#336699] to-[#003366] relative overflow-hidden">
                                ...
                                <div class="absolute bottom-0 left-0 right-0 p-6 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                                    <p class="text-white text-sm">{{ $project->description ?? 'Custom construction project with precision and attention to detail.' }}</p>
                                </div>
                                <div class="absolute top-4 left-4">
                                    <span class="bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-xs font-medium text-[#003366] shadow-sm capitalize">{{ $project->category }}</span>
                                </div>
    ...
    <section id="services" class="py-24 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20 reveal">
                <span class="text-sm font-medium text-[#336699] dark:text-[#4a90e2] uppercase tracking-wider mb-4 block">{{ $services['badge'] }}</span>
                <h2 class="text-4xl md:text-5xl font-serif font-bold text-[#003366] dark:text-white mb-6">{{ $services['title'] }}</h2>
                <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 reveal">
                    <div class="w-16 h-16 bg-gradient-to-br from-[#336699] to-[#003366] rounded-lg flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $services['service1']['svg_path'] }}"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-serif font-bold text-[#003366] dark:text-white mb-4">{{ $services['service1']['title'] }}</h3>
                ...
                <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 reveal">
                    <div class="w-16 h-16 bg-gradient-to-br from-[#336699] to-[#003366] rounded-lg flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $services['service2']['svg_path'] }}"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-serif font-bold text-[#003366] dark:text-white mb-4">{{ $services['service2']['title'] }}</h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 reveal">
                    <div class="w-16 h-16 bg-gradient-to-br from-[#336699] to-[#003366] rounded-lg flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $services['service3']['svg_path'] }}"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-serif font-bold text-[#003366] dark:text-white mb-4">{{ $services['service3']['title'] }}</h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
    ...
    <section id="testimonials" class="py-24 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20 reveal">
                <span class="text-sm font-medium text-[#336699] dark:text-[#4a90e2] uppercase tracking-wider mb-4 block">{{ $testimonials['badge'] }}</span>
                <h2 class="text-4xl md:text-5xl font-serif font-bold text-[#003366] dark:text-white mb-6">{{ $testimonials['title'] }}</h2>
                <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-4">
            ...
            <div class="relative" x-data="{ currentSlide: 0, testimonials: [
                {
                    name: @js($testimonials['testimonial1']['name']),
                    role: @js($testimonials['testimonial1']['role']),
                    project: @js($testimonials['testimonial1']['project']),
                    rating: @js($testimonials['testimonial1']['rating']),
                    text: @js($testimonials['testimonial1']['text']),
                    image: @js($testimonials['testimonial1']['image'])
                },
                {
                    name: @js($testimonials['testimonial2']['name']),
                    role: @js($testimonials['testimonial2']['role']),
                    project: @js($testimonials['testimonial2']['project']),
                    rating: @js($testimonials['testimonial2']['rating']),
                    text: @js($testimonials['testimonial2']['text']),
                    image: @js($testimonials['testimonial2']['image'])
                },
                {
                    name: @js($testimonials['testimonial3']['name']),
                    role: @js($testimonials['testimonial3']['role']),
                    project: @js($testimonials['testimonial3']['project']),
                    rating: @js($testimonials['testimonial3']['rating']),
                    text: @js($testimonials['testimonial3']['text']),
                    image: @js($testimonials['testimonial3']['image'])
                }
            ]}">
    ...
    <section id="contact" class="py-24 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20 reveal">
                <span class="text-sm font-medium text-[#336699] dark:text-[#4a90e2] uppercase tracking-wider mb-4 block">{{ $contact['badge'] }}</span>
                <h2 class="text-4xl md:text-5xl font-serif font-bold text-[#003366] dark:text-white mb-6">{{ $contact['title'] }}</h2>
                <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-4">
                    {{ $contact['description'] }}
                </p>
                <div class="w-20 h-0.5 bg-[#CCCC99] dark:bg-[#4a90e2] mx-auto"></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <a href="tel:{{ $contact['phone_link'] }}" class="text-[#336699] dark:text-[#4a90e2] hover:text-[#003366] dark:hover:text-white transition-colors">{{ $contact['phone'] }}</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <a href="mailto:{{ $contact['email'] }}" class="text-[#336699] dark:text-[#4a90e2] hover:text-[#003366] dark:hover:text-white transition-colors">{{ $contact['email'] }}</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-300">{{ $contact['hours'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Contact Form -->
                <div class="reveal">
                    <h3 class="text-3xl font-serif font-bold text-[#003366] dark:text-white mb-8">{{ $contact['form_title'] }}</h3>
            ...
            <div class="mt-16 reveal">
                <div class="rounded-2xl overflow-hidden shadow-2xl" style="height: 400px;">
                    <iframe src="{{ $contact['google_maps_embed_url'] ?? $contact['map_url'] ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3024.184133583885!2d-73.94482368459418!3d40.67834397932778!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25bae6c5b3b3b%3A0x8b5e5e5e5e5e5e5e!2sBrooklyn%2C%20NY%2C%20USA!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus' }}" 
                            width="100%" 
                            height="400" 
                            style="border:0;" 
                            allowfullscreen="" 
