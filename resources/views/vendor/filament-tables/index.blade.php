                ...
                @if (! $isSelectionDisabled)
                    <div>
                        ...
                        <div class="fi-ta-selection-indicator-actions-ctn">
                            ...
                            >
                                @php
                                    $formattedCount = extension_loaded('intl') 
                                        ? \Illuminate\Support\Number::format($allSelectableRecordsCount, locale: app()->getLocale())
                                        : number_format($allSelectableRecordsCount, 0, '.', ',');
                                @endphp
